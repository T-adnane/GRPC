...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<miaad.sd.stubs.Bank.ConvertCurrencyRequest,
      miaad.sd.stubs.Bank.ConvertCurrencyResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "convert",
      requestType = miaad.sd.stubs.Bank.ConvertCurrencyRequest.class,
      responseType = miaad.sd.stubs.Bank.ConvertCurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<miaad.sd.stubs.Bank.ConvertCurrencyRequest,
      miaad.sd.stubs.Bank.ConvertCurrencyResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<miaad.sd.stubs.Bank.ConvertCurrencyRequest, miaad.sd.stubs.Bank.ConvertCurrencyResponse> getConvertMethod;
    if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
          BankServiceGrpc.getConvertMethod = getConvertMethod = 
              io.grpc.MethodDescriptor.<miaad.sd.stubs.Bank.ConvertCurrencyRequest, miaad.sd.stubs.Bank.ConvertCurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BankService", "convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  miaad.sd.stubs.Bank.ConvertCurrencyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  miaad.sd.stubs.Bank.ConvertCurrencyResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<miaad.sd.stubs.Bank.ConvertCurrencyRequest,
      miaad.sd.stubs.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<miaad.sd.stubs.Bank.ConvertCurrencyRequest,
      miaad.sd.stubs.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<miaad.sd.stubs.Bank.ConvertCurrencyRequest, miaad.sd.stubs.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<miaad.sd.stubs.Bank.ConvertCurrencyRequest,
      miaad.sd.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<miaad.sd.stubs.Bank.ConvertCurrencyRequest,
      miaad.sd.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod() {
    io.grpc.MethodDescriptor<miaad.sd.stubs.Bank.ConvertCurrencyRequest, miaad.sd.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<miaad.sd.stubs.Bank.ConvertCurrencyRequest,
      miaad.sd.stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<miaad.sd.stubs.Bank.ConvertCurrencyRequest,
      miaad.sd.stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<miaad.sd.stubs.Bank.ConvertCurrencyRequest, miaad.sd.stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod;
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void convert(miaad.sd.stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<miaad.sd.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getCurrencyStream(miaad.sd.stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<miaad.sd.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<miaad.sd.stubs.Bank.ConvertCurrencyRequest> performStream(
        io.grpc.stub.StreamObserver<miaad.sd.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<miaad.sd.stubs.Bank.ConvertCurrencyRequest> fullCurrencyStream(
        io.grpc.stub.StreamObserver<miaad.sd.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                miaad.sd.stubs.Bank.ConvertCurrencyRequest,
                miaad.sd.stubs.Bank.ConvertCurrencyResponse>(
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractStub<BankServiceBlockingStub> {
     ...
     * </pre>
     */
    public miaad.sd.stubs.Bank.ConvertCurrencyResponse convert(miaad.sd.stubs.Bank.ConvertCurrencyRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<miaad.sd.stubs.Bank.ConvertCurrencyResponse> getCurrencyStream(
        miaad.sd.stubs.Bank.ConvertCurrencyRequest request) {
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractStub<BankServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<miaad.sd.stubs.Bank.ConvertCurrencyResponse> convert(
        miaad.sd.stubs.Bank.ConvertCurrencyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((miaad.sd.stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<miaad.sd.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        case METHODID_GET_CURRENCY_STREAM:
          serviceImpl.getCurrencyStream((miaad.sd.stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<miaad.sd.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return miaad.sd.stubs.Bank.getDescriptor();
    }
